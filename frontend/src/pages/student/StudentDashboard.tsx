                  ...
                  {courses.slice(0, 4).map(course => (
                    ...
                    >
                      ...
                      <div className="p-5 flex-1 flex flex-col justify-between">
                        <div>
                          <h3 className="text-base font-display font-semibold text-[#22243A] dark:text-[#F4F4FA] line-clamp-2 group-hover:text-[#6C63F2] dark:group-hover:text-[#8B82FF] transition-colors">
                            {course.title}
                          </h3>
                        </div>
