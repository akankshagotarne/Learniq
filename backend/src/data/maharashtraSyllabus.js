/**
 * Maharashtra State Board (Balbharati / MSCERT, SSC Pattern) Syllabus Specification
 * Complete Subject-wise Course Data for Standards 1 to 10 (English Medium)
 */
...
const COURSES_SPEC = [
  ...
  },
  {
    ...
    price: 99,
    isFlagged: true,
    flagReason: '⚠️ Chapter list could not be independently verified from official eBalbharati scans. Placeholder outline provided pending verification.',
    chapters: [
